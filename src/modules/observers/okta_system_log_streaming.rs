...
mod tests {
    ...
    fn metadata_complete() {
        ...
        let obs = SystemLogStreamingObserver;
        assert_eq!(obs.id(), "okta.system_log_streaming");
    ...
    fn domain_only_uses_https_prefix() {
        ...
        let result = SystemLogStreamingObserver.observe(&cfg);
    ...
    fn api_returns_403_errors() {
        ...
        let result = SystemLogStreamingObserver.observe(&base_config(&srv));
        assert!(result.is_err());
