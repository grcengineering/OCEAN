...
pub fn register_all(registry: &Registry) {
    ...
    registry.register_observer(Arc::new(okta_system_log_streaming::SystemLogStreamingObserver));
    ...
    registry.register_observer(Arc::new(github_org_base_permissions::OrgBasePermissionsObserver));
    ...
    registry.register_observer(Arc::new(github_environment_protection::EnvironmentProtectionObserver));
    ...
    registry.register_observer(Arc::new(github_audit_log_streaming::AuditLogStreamingObserver));
    registry.register_observer(Arc::new(github_security_config::SecurityConfigObserver));
    registry.register_observer(Arc::new(github_copilot_governance::CopilotGovernanceObserver));
}
